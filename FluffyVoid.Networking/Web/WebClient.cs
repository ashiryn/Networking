...
namespace FluffyVoid.Networking.Web
{
    ...
    public class WebClient
    {
        ...
        /// <summary>
        ///     Singleton instance to aid in keeping a single http client no matter how
        ///     many the project tries to create
        /// </summary>
        private static volatile HttpClient? s_instance;

        /// <summary>
        ///     Instance variable for the singleton that ensures the singleton is always
        ///     created
        /// </summary>
        ...
        /// <summary>
        ///     Event to notify that a request has failed due to not having proper
        ///     authorization
        /// </summary>
        public event EventHandler<WebMessage>? AuthorizationFailed;

        /// <summary>
        ///     Downloads a file from the requested URL and saves it at the desired
        ///     filepath location
        /// </summary>
        ...
        public async Task DownloadFileAsync(string url, string filePath)
        {
            ...
            try
            {
                await using Stream urlStream =
                    await Instance.GetStreamAsync(url);
