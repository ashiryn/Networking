...
namespace FluffyVoid.Networking.Web
{
    ...
    public class WebMessage : IDisposable, IDeepCloneable<WebMessage>
    {
        ...
        /// <summary>
        ///     Constructor that does no initialization, for use by inherited classes when
        ///     wanting to do full initialization at
        ///     that level
        /// </summary>
        public WebMessage()
        {
        ...
        /// <param name="requestId">A custom id to assign to the message</param>
        protected WebMessage(HttpRequestMessage request,
                             int                failureCount,
                             int                requestId = -1)
        {
        ...
        /// <summary>
        ///     Adds the passed in content to the message with the desired content type and
        ///     encoding style
        /// </summary>
        /// <param name="content">The content to set as the payload</param>
        /// <param name="type">The content type to set the payload as</param>
        ...
        {
            Request.Content =
                new StringContent(content, contentEncoding,
                                  type.GetDescription());
        }
        /// <summary>
        ...
        public virtual void AddUserAgent(string name,
                                         string version,
                                         string comment)
        {
        ...
        /// <param name="url">The url endpoint for the message</param>
        /// <param name="requestId">A custom id to assign to the message</param>
        public virtual void Initialize(WebMethod method,
                                       string    url,
                                       int       requestId = -1)
        {
            FailureCount = 0;
        ...
        where T : Enum
    {
        ...
        /// <param name="url">The url endpoint for the message</param>
        /// <param name="identity">
        ///     The api identity/type of message when using multiple
        ///     apis
        /// </param>
        /// <param name="requestId">A custom id to assign to the message</param>
        public WebMessage(WebMethod method,
                          string    url,
                          T?        identity,
                          int       requestId = -1)
            : base(method, url, requestId)
        ...
        {
            return new WebMessage<T>(Request, Identity, FailureCount,
                                     RequestId);
        }
        /// <summary>
        ///     Initializes the WebMessage with values needed to send a request
        ...
        /// </param>
        /// <param name="requestId">A custom id to assign to the message</param>
        public void Initialize(WebMethod method,
                               string    url,
                               T         identity,
                               int       requestId = -1)
        {
