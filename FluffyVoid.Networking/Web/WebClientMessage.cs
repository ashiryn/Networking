namespace FluffyVoid.Networking.Web
{
    ...
    {
        /// <summary>
        ///     Request callback that will be called when the message has received a
        ///     response back
        /// </summary>
        ...
        /// <summary>
        ///     Copy constructor that can build a copy of the message but updates the HTTP
        ///     request properly
        /// </summary>
        ...
        ///     The current number of failed attempts for this
        ///     message
        /// </param>
        ...
        public override void Process(HttpResponseMessage message,
                                     string              payload)
        {
