...
{
    /// <summary>
    ///     Utility class used to read and write an udp network stream to a dev
    ///     friendly
    ///     packet
    /// </summary>
    ...
    {
        /// <summary>
        ///     The buffer mode to assign to the message, helps to prevent trying to read
        ///     from a write buffer and vice versa
        /// </summary>
        ...
        /// <summary>
        ///     Constructor used to builds a message for use in writing to the network
        ///     stream
        /// </summary>
        ...
        /// <summary>
        ///     Returns the reader assigned to this message for use in reading variables
        ///     from the network stream
        /// </summary>
        /// <returns>
        ///     The assigned reader if the message is in Read mode, otherwise an empty
        ///     reader
        /// </returns>
        ...
        /// <summary>
        ///     Returns the writer assigned to this message for use in writing variables to
        ///     the network stream
        /// </summary>
        /// <returns>
        ///     The assigned writer if the message is in Write mode, otherwise an
        ///     empty writer
        /// </returns>
