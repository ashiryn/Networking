...
{
    /// <summary>
    ///     Class used to allow external classes to register to incoming network
    ///     messages with an appropriate callback
    /// </summary>
    /// <typeparam name="TNetworkMessage">
    ///     The type of network message the dispatcher is
    ///     responsible for
    /// </typeparam>
    /// <typeparam name="TNetworkEventArgs">
    ///     The type of event args that the dispatcher
    ///     is expecting to work with
    /// </typeparam>
    ...
    {
        /// <summary>
        ///     Queue used to store and free up network message handling quicker, items are
        ///     dispatched during an update cycle
        /// </summary>
        protected Queue<TNetworkEventArgs> DispatchQueue { get; private set; } =
            new Queue<TNetworkEventArgs>();
        /// <summary>
        ///     Routing table for incoming message traffic to callbacks based on the Tag of
        ///     a message
        /// </summary>
        ...
        /// <param name="route">
        ///     The callback to use when a message with the desired tag is
        ///     received
        /// </param>
        ...
        /// <summary>
        ///     Checks for any queued message events to dispatch, dispatching 1 per cycle
        ///     if any exist
        /// </summary>
        ...
        /// <summary>
        ///     Helper function used to check for and fire callbacks for the incoming
        ///     message event arg
        /// </summary>
