...
namespace FluffyVoid.Networking.Udp
{
    ...
    public class NetworkUdpClient : IDisposable
    {
        ...
        /// <summary>
        ///     Event raised when the client has received a message from the server that it
        ...
        /// </summary>
        /// <param name="hostName">
        ///     The host name to connect to, E.G.
        ///     www.ashiryn.servequake.com
        /// </param>
        ...
        public void Disconnect()
        {
            ...
            Disconnected?.Invoke(this,
                                 new ClientDisconnectedEventArgs(true, info));
        ...
        /// <summary>
        ///     Listen loop used to allow the client to listen for network traffic without
        ...
        /// <summary>
        ///     Sends a connection message to the server with the currently registered name
        ///     of the client
        /// </summary>
        /// <returns>The number of bytes sent out</returns>
