...
namespace FluffyVoid.Networking.Udp
{
    ...
    public class UdpWriter : UdpStream
    {
        ...
        ///     The byte buffer for the requested variable to be
        ...
        {
            int count =
                WriteToBuffer(BitConverter.GetBytes((ushort)value.Length));
        ...
        /// <summary>
        ///     Helper function used to verify the BufferMode has been set to Write, as
        ///     well as writing within the bounds of the
        ///     stream
        /// </summary>
        /// <param name="itemBuffer">
        ///     The byte buffer for the requested variable to be
