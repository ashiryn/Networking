...
{
    /// <summary>
    ///     Serializable data class that a client can send to register receiving
    ///     messages for the desired tags only
    /// </summary>
    public class ClientMessageTagRegistration : IUdpSerializable
    {
        ...
        /// <summary>
        ///     Deserializes the list of tags from an udp stream
        /// </summary>
        ...
        /// <summary>
        ///     Serializes the list of tags to an udp stream
        /// </summary>
