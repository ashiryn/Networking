namespace FluffyVoid.Networking.Udp
{
    ...
    public class ClientConnectionInformation : IUdpSerializable
    {
        ...
        /// </summary>
        /// <remarks>
        ///     Most often used by the server to inform the connecting client if the
        ///     connection was successful and their new client
        ///     ID
        /// </remarks>
        /// <param name="name">The name the client will be connecting as</param>
        ...
        /// <summary>
        ///     Deserialization method used to deserialize the data in this class from a
        ///     network byte stream
        /// </summary>
        /// <param name="e">
        ///     The serialization event arg to use in the deserialization
        ///     process
        /// </param>
        ...
        /// <summary>
        ///     Serialization method used to serialize the data in this class to a network
        ///     byte stream
        /// </summary>
